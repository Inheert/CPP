...
/*   Updated: 2024/11/06 10:36:29 by tclaereb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap( std::string name ) : _name(name), _health(10), _energy(10), _damage(5) {
...
void	ClapTrap::cantDoAnyAction( std::string action ) const {
	if (!this->_health)
		std::cout << "ClapTrap can't " << action << " because he is died." << std::endl;
	if (!this->_energy)
		std::cout << "ClapTrap can't " << action << " because he doesn't have enough energy." << std::endl;
}
